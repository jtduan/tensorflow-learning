...
if __name__ == '__main__':
    ...
    meta_graph_def = tf.saved_model.loader.load(sess, ['ctc_demo_model'], "./temp/model2/outModel/")
    ...
    img, label = DataIter().generateRamdomNumber(5)
    ...
    out = sess.run(y, feed_dict={x1: img3, x2: [64]})  ##根据输入执行输出
    print out
    sess.close()
